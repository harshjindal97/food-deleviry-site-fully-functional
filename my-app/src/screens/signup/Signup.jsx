        ...
        <div className="card rounded-3 signup">
          ...
          <div className="card-body p-4 p-md-5">
            ...
            <form className="px-md-2" onSubmit={handleSubmit}>
              ...
              <div className="form-outline mb-4">
                <input type="text" id="form3Example1q" className="form-control" name='email' value={credentials.email} onChange={onChange}/>
                <label className="form-label" for="form3Example1q">Email Address</label>
              </div>
              ...
              <div className="row mb-4 pb-2 pb-md-0 mb-md-5">
                <div className="col-md-6">
                  ...
                  <div className="form-outline">
                    <input type="text" id="form3Example1w" className="form-control" name='password' value={credentials.password} onChange={onChange}/>
                    <label className="form-label" for="form3Example1w">Password</label>
                  </div>
